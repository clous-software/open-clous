...
const Hi = ({ params: { locale } }: { params: { locale: string } }) => {
  ...
  return (
    <>
      ...
      <header className="bg-[#FAFAFA] bg-pattern bg-gradient-to-br from-gray-50 to-gray-100 text-dark-blue-greenish mx-auto max-w-8xl pt-24 px-4 sm:px-6 xl:px-16 2xl:px-24">
        <p>hello</p>
