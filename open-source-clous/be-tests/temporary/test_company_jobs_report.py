...
def test_company_jobs_report():
    """Test the company-wide jobs report generation"""
    ...
    try:
        ...
        # Generate company jobs report
        print("Generating company jobs report...")
        insights, embedding, blocks, *extras = report_service._handle_report_document(
            company=company,
            report_type="company_jobs",
            content="Generate a comprehensive analysis of all jobs in the company, highlighting trends, gaps in the hiring pipeline, and strategic recommendations."
        )
