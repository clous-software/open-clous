...
import getNotesEditing from "@/app/api/ai/route";
...
export const useVoiceEditing = ({ isVoiceMode, setUserMessage, setShouldGenerate }: UseVoiceRecorderProps) => {
        ...
        .then(stream => {
          ...
          mediaRecorder.onstop = async () => {
            ...
            try {
              ...
              const responseTranscript = await getNotesEditing(formData); // Assuming getAudioTranscript is defined elsewhere
              console.log("API response:", responseTranscript);

              if (responseTranscript && responseTranscript.new_notes) {
                resolve(responseTranscript.new_notes);
              } else {
