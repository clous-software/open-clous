...
function BusinessTerms() {
  ...
  mixpanel.track("Business Terms Page");
  return (
    <Layout>
      <Helmet>
...
<div className="z-40 relative">
      ...
      <div className="pt-28 px-6">
        ...
        <p>
        These Clous Business Terms govern use of our APIs, Clous Enterprise, Peer Team, and other services for businesses and developers. Use of our services for individuals, such as Clous Peer or ClousH, are governed by the Terms of use.

Thank you for choosing Clous!

These Business Terms are an agreement between Clous Technology, SL. and you (“Customer”) that governs your use of our Services (as defined below). If you reside within a European Economic Area country or Switzerland, your agreement is with Clous Technology SL. By signing up to use the Services, you agree to be bound by these Business Terms. You represent to us that you are lawfully able to enter into contracts and, if you are entering into these Business Terms for an entity, that you have legal authority to bind that entity. These Business Terms also refer to and incorporate the Service Terms, Sharing & Publication Policy, Usage Policies, and any other guidelines or policies we may provide in writing (the “Clous Policies”) and any ordering document signed by you and Clous or Clous webpage that you use to purchase the Services (an “Order Form”) (collectively, the “Agreement”).

1. Services
1.1 Use of Services. We grant you a non-exclusive right to access and use the Services during the Term (as defined below). This includes the right to use Clous’ application programming interfaces (“APIs”) to integrate the Services into your applications, products, or services (each a “Customer Application”) and to make Customer Applications available to End Users (as defined below). “Services” means any services for businesses and developers we make available for purchase or use, along with any of our associated software, tools, developer services, documentation, and websites, but excluding any Third Party Offering.
...
(a) use the Services or Customer Content (as defined below) in a manner that violates any applicable laws or Clous Policies;
...
3. Content
3.1 Customer Content. You and End Users may provide input to the Services (“Input”), and receive output from the Services based on the Input (“Output”). We call Input and Output together “Customer Content.” As between you and Clous, and to the extent permitted by applicable law, you (a) retain all ownership rights in Input and (b) own all Output. We hereby assign to you all our right, title, and interest, if any, in and to Output.

3.2 Our Obligations for Customer Content. We will process and store Customer Content in accordance with our Enterprise privacy commitments. We will only use Customer Content as necessary to provide you with the Services, comply with applicable law, and enforce Clous Policies. We will not use Customer Content to develop or improve the Services.
...
7.4 Disputes and Late Payments. To dispute an invoice, you must contact avillalba@clous.app within thirty (30) days of issuance. Overdue undisputed amounts may be subject to a finance charge of 1.5% of the unpaid balance per month, and we may suspend the Services immediately after providing written notice of late payment.
...
10.2 By Customer. You agree to indemnify, defend, and hold us and our affiliates and licensors harmless against any liabilities, damages, and costs (including reasonable attorneys’ fees) payable to a third party arising out of a third party claim related to (a) use of the Services in violation of this Agreement (including violation of Clous Policies), (b) Customer Applications (if any), or (c) Input.
...
13.1 MANDATORY ARBITRATION. You and Clous agree to resolve any claims arising out of or relating to this Agreement or our Services, regardless of when the claim arose, even if it was before this Agreement existed (a “Dispute”), through final and binding arbitration.
...
13.3 Arbitration Forum. Both you or Clous may commence binding arbitration through National Arbitration and Mediation (NAM), an alternative dispute resolution provider, and if NAM is not available, you and Clous will select an alternative arbitral forum. The initiating party must pay all filing fees for the arbitration and payment for other administrative and arbitrator’s costs will be governed by the arbitration provider’s rules. If your claim is determined to be frivolous, you are responsible for reimbursing us for all administrative, hearing, and other fees that we have incurred as a result of the frivolous claim.
...
14. Modifications to these Business Terms and the Clous Policies
14.1 Updates. We may update these Business Terms or the Clous Policies by providing you with reasonable notice, including by posting the update on our website. If, in our sole judgment, an update materially impacts your rights or obligations, we will provide at least 30 days’ notice before the update goes into effect, unless the update is necessary for us to comply with applicable law, in which case we will provide you with as much notice as reasonably possible. Any other updates will be effective on the date we post the updated Business Terms or Clous Policies. Your continued use of, or access to, the Services after an update goes into effect will constitute acceptance of the update. If you do not agree with an update, you may stop using the Services or terminate this Agreement under Section 8.2 (Termination). 

14.2 Exceptions to Updates. Except for an update to comply with applicable law, updates to these Business Terms or the Clous Policies will not apply to: (a) Disputes between you and Clous arising prior to the update; or (b) Order Forms signed by you and Clous (as opposed to an automated ordering page) prior to us notifying you of the update. However, to the extent an update relates to a Service or feature launched after an Order Form is signed it will be effective upon your first use of such Service
...
15.5 Entire Agreement. This Agreement is the entire agreement between you and Clous with respect to its subject matter and supersedes all prior or contemporaneous agreements, communications and understandings, whether written or oral. You agree that any terms and conditions contained within any purchase order you send to us will not apply to this Agreement and are null and void.

15.6 Relationship of the Parties. For all purposes under this Agreement, you and Clous will be and act as an independent contractor and will not bind nor attempt to bind the other to any contract.

15.7 No Third Party Beneficiaries. There are no intended third party beneficiaries to this Agreement, and it is your and Clous’ specific intent that nothing contained in this Agreement will give rise to any right or cause of action, contractual or otherwise, in or on behalf of any third party.

15.8 Force Majeure. Except for payment obligations, neither you nor Clous will have any liability for failures or delays resulting from conditions beyond your or Clous’ reasonable control, including but not limited to governmental action or acts of terrorism, earthquake or other acts of God, labor conditions, or power failures. 

15.9 Assignment. This Agreement cannot be assigned other than as permitted under this Section 15.9 (Assignment). We may assign this Agreement to an affiliate without notice or your consent. Both you and Clous may assign this Agreement to a successor to substantially all the respective party’s assets or business, provided that the assigning party provides reasonable (at least 30 days) prior written notice of the assignment. This Agreement will be binding upon the parties and their respective successors and permitted assigns. 

15.10 Notices. All notices will be in writing. We may provide you notice using the registration information or the email address associated with your account. Service will be deemed given on the date of receipt if delivered by email or on the date sent via courier if delivered by post. We accept service of process at this address: Clous Technology, S.L., 28003 Madrid, Spain.
