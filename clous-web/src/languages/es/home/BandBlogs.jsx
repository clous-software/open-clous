...
function BandBlogs() {
  return (
         ...
         <img
            ...
            "
              ...
              <h3 className="text-4xl ">
                Qué Esperar de la Selección de Talento en 2024
              </h3>
              <p className="mt-4 font-medium text-sm rounded-full px-3 py-0.5 border border-2 bg-gray-200 inline-flex text-[#333333] mb-2">
                Recruitment

                </p>
              <p className="">
                6 February, 2024 · 9 min leyendo
              </p>
            </div>
          </div>
        </Link>
        <Link to="http://www.clous.app/clous-wiki/e7da1dec-ee72-422c-9c1c-5423ec1f2bde" target="_blank" className="relative overflow-hidden transition duration-500 rounded-lg lg:hover:text-primary group-hover:shadow-xl"
        >
          <img
            ...
            "
              ...
              <h3 className="text-4xl">
                {" "}
                Clous Demo ya accesible desde la web
              </h3>
              <p className="mt-4">
                22 November, 2023 · 2 min leyendo
              </p> 
    ...
    <NegativeButton name="All blogs" linkUrl="/blog"/>
    </div>
    </main>
    );
}
