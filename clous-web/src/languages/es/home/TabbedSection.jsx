...
const TabsSection = () => {
  ...
  <div className="bg-primary rounded-3xl px-2 py-8 lg:py-16 justify-center">
    <h2 className="text-3xl lg:text-6xl text-center text-secondary font-semibold mb-8">
      Si creas empleo, <br/> estás en el lugar correcto
      </h2>
        ...
        {activeTab === 'tab1' && <section className='rounded-xl lg:flex justify-between lg:px-12 overflow-hidden' >
          ...
          <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[19rem] text-[#333333]'>
            ...
            <Lottie className='w-20 h-20' animationData={involveOne}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Experiencias personalizadas para candidatos</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={recurring}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Convierte al talento en recurrente</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={saveHours}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Usa tus datos para tareas repetitivas</h3>
            </li>
                     
          </ul>
        </section> }
        {activeTab === 'tab2' && <section className=' rounded-xl lg:flex justify-between lg:px-12  overflow-hidden' >
        <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:min-h-[19rem] h-auto text-[#333333]'>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={involveTwo}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Comparte feedback personalizado</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={schedule}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Programa entrevistas hoy para mañana</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={talent}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Diseña la experiencia del candidato</h3>
            </li>
                     
          </ul>

        </section> }
        {activeTab === 'tab3' && <section className='rounded-xl lg:flex justify-between lg:px-12' >
        <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[19rem] text-[#333333]'>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={costs}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>No uses 20+ herramientas</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={action}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Usa tus datos y toma acción</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={share}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Mejora con cada puesto</h3>
            </li>
