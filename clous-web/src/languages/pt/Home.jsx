...
function Home() {
  ...
  return (
    <Layout>
      <Helmet>
      <title>Contratação de IA para Produtividade em Equipes de Contratação - Clous</title>

<meta name="description" content="A Clous desenvolveu um assistente de contratação de IA chamado Clous Peer. Ele foi desenvolvido para ajudar a envolver e reter candidatos recorrentes da inscrição à entrevista." />
...
<meta property="og:title" content="Contratação de IA para Produtividade em Equipes de Contratação - Clous" />
<meta property="og:description" content="A Clous desenvolveu um assistente de contratação de IA chamado Clous Peer. Ele foi desenvolvido para ajudar a envolver e reter candidatos recorrentes da inscrição à entrevista." />
      </Helmet>
