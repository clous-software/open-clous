...
const TabsSection = () => {
  ...
  <div className="bg-primary rounded-3xl px-2 py-8 lg:py-16 justify-center">
    ...
    Conecte pessoas a
 <br/> um caminho de carreira gratificante
      ...
      <section className="pt-4">
        {activeTab === 'tab1' && <section className='rounded-xl lg:flex justify-between lg:px-12 overflow-hidden' >
          ...
          <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[19rem] text-[#333333]'>
            ...
            <Lottie className='w-20 h-20' animationData={involveOne}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Crie experiências de candidatos personalizadas</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={recurring}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Transforme seus candidatos em talentos recorrentes</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={saveHours}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Use seus dados para economizar horas em tarefas repetitivas</h3>
            </li>
        ...
        <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[19rem] text-[#333333]'>
            ...
            <Lottie className='w-20 h-20' animationData={involveTwo}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Compartilhar feedback personalizado</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={schedule}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Agendar entrevistas para amanhã ainda hoje</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={talent}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Construir sua experiência de candidato</h3>
            </li>
        ...
        <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[19rem] text-[#333333]'>
            ...
            <Lottie className='w-20 h-20' animationData={costs}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Evite usar outras ferramentas com custos ocultos</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={action}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Use seus dados para gerar ações e insights</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={share}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Simplifique suas contratações com cada vaga aberta</h3>
            </li>
