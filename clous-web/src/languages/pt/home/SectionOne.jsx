  ...
  return (
    <main className="lg:py-16 lg:mt-32 py-8 px-8 lg:px-24">
      ...
      <div className="relative w-full h-full">
          ...
          <FeatureCard
            title="Entreviste candidatos uma vez, retenha-os para sempre"
            description="Já teve muitos ótimos candidatos, mas apenas uma vaga de emprego? As ferramentas existentes não são projetadas para engajar talentos para futuras oportunidades de emprego. Nosso objetivo é transformar candidatos transacionais em talentos recorrentes."
          />
         {/*  <img
        ...
        <div className={`lg:flex h-[20rem] lg:gap-16 transition-opacity duration-500 ${isVisible[1] ? "opacity-100" : "opacity-0"} section-transition`}>
          ...
          <FeatureCard
            title="Pare de pagar mais de 4 assinaturas para contratar"
            description="Você usa o LinkedIn para anunciar uma oferta de emprego e enviar mensagens para candidatos, uma ferramenta ATS para gerenciar candidatos, o Calendly para agendar entrevistas e o ChatGPT para redigir descrições de empregos."
          />
