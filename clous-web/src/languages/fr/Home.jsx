...
function Home() {
  ...
  return (
    <Layout>
      <Helmet>
      <title>Recrutement IA pour la productivité dans les équipes de recrutement - Clous</title>

<meta name="description" content="Clous a développé un assistant de recrutement IA appelé Clous Peer. Il est conçu pour aider à engager et à fidéliser les candidats récurrents de la candidature à l'entretien." />
...
<meta property="og:title" content="Recrutement IA pour la productivité dans les équipes de recrutement - Clous" />
<meta property="og:description" content="Clous a développé un assistant de recrutement IA appelé Clous Peer. Il est conçu pour aider à engager et à fidéliser les candidats récurrents de la candidature à l'entretien." />
