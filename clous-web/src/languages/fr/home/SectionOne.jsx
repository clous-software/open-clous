  ...
  return (
    <main className="lg:py-16 lg:mt-32 py-8 px-8 lg:px-24">
      ...
      <div className="relative w-full h-full">
          ...
          <FeatureCard
            title="Interview candidates once, retain them forever"
            description="Ever had many great candidates but just one job opening? Existing tools are not designed to engage with talent for future job opportunities. Our goal is turn transactional candidates to recurring talent."
          />
         {/*  <img
        ...
        <div className={`lg:flex h-[20rem] lg:gap-16 transition-opacity duration-500 ${isVisible[1] ? "opacity-100" : "opacity-0"} section-transition`}>
          ...
          <FeatureCard
            title="Stop paying 4+ subscriptions to hire"
            description="You use Linkedin to advertise a job offer and message candidates, an ATS tool to manage candidates, Calendly to schedule interviews, and ChatGPT to draft job descriptions."
          />
