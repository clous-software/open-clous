...
const TabsSection = () => {
  ...
  <div className="bg-primary rounded-3xl px-2 py-8 lg:py-16 justify-center">
    <h2 className="text-3xl lg:text-6xl text-center text-secondary font-semibold mb-8">
        Connect people to <br/> a fulfilling career path
      </h2>
      ...
      <section className="pt-4">
        {activeTab === 'tab1' && <section className='rounded-xl lg:flex justify-between lg:px-12 overflow-hidden' >
          ...
          <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[19rem] text-[#333333]'>
            ...
            <Lottie className='w-20 h-20' animationData={involveOne}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Create personal candidate experiences</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
        ...
        <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[19rem] text-[#333333]'>
            ...
            <Lottie className='w-20 h-20' animationData={involveTwo}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Partager des commentaires personnalisés</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={schedule}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Planifier des entretiens pour demain dès aujourd'hui</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={talent}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Créer votre expérience candidat</h3>
            </li>
        ...
        <ul className='grid grid-cols-1 lg:grid-cols-3 gap-8 lg:h-[19rem] text-[#333333]'>
            ...
            <Lottie className='w-20 h-20' animationData={costs}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Évitez d'utiliser d'autres outils avec des coûts cachés</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={action}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Utilisez vos données pour générer des actions et des insights</h3>
            </li>
            <li className='text-lg font-medium p-4 rounded-3xl justify-start bg-main-white h-full'>
            <Lottie className='w-20 h-20' animationData={share}/>
                <h3 className='gap-2 leading-none mt-20 text-4xl'>Simplifiez vos recrutements avec chaque offre d'emploi</h3>
            </li>
