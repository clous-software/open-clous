  ...
  const renderButtons = () => {
    return (
      <div className="flex flex-col justify-center items-center text-xl gap-2 fadeOut">
                ...
                <NormalButton name="Essayez Clous" linkUrl="https://beta.clous.app" target="_blank" onClick={() => trackButtonClick("Demo")}/>
                <div className="flex items-center gap-2 mt-2">
                <p className="text-base text-dark-gray font-medium flex gap-2 items-center">
                Essayez gratuitement</p> <div className="w-1 h-1 rounded-full bg-dark-gray"></div>
<p className="text-base text-dark-gray font-medium flex gap-2 items-center"><IoCard className="w-4 h-4"/>
Aucune carte de crédit requise</p>
</div>
  ...
  const ScrollHeader = ({ translate }) => {
    return (
      ...
      > 
        <h1 className="text-3xl lg:text-6xl fadeOut mb-8" loading="lazy">
        Talent engagé de la<br />{' '}
          <span className="text-5xl lg:text-8xl font-bold mt-4">
          demande à l'entretien
          </span>
        </h1>
        {renderButtons()}
...
{/* Video de Demo de Clous Peer */}
      {isVideoModalOpen && (
        ...
        >
          <div className="relative w-11/12 h-3/4 bg-white rounded-3xl">
            {/* YouTube Video iframe */}
            <iframe
              className="absolute top-0 left-0 w-full h-full rounded-3xl"
              src="https://www.youtube.com/embed/I-L0WrMaVsg?si=0IQtnE5qvcDws91e"
