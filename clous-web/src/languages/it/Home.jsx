...
function Home() {
  ...
  return (
    <Layout>
      <Helmet>
      <title>Assunzione di AI per la produttività nei team di assunzione - Clous</title>

<meta name="description" content="Clous ha sviluppato un assistente di assunzione AI chiamato Clous Peer. È progettato per aiutare ad impegnare e trattenere i candidati ricorrenti dalla candidatura al colloquio." />
...
<meta property="og:title" content="Assunzione di AI per la produttività nei team di assunzione - Clous" />
<meta property="og:description" content="Clous ha sviluppato un assistente di assunzione AI chiamato Clous Peer. È progettato per aiutare ad impegnare e trattenere i candidati ricorrenti dalla candidatura al colloquio." />
