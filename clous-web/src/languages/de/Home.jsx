...
function Home() {
  ...
  return (
    <Layout>
      <Helmet>
      <title>AI zur Steigerung der Produktivität in Einstellungsteams - Clous Startseite</title>

<meta name="description" content="Clous hat einen KI-Einstellungsassistenten namens Clous Peer entwickelt. Es wurde entwickelt, um wiederkehrende Kandidaten von der Bewerbung bis zum Interview zu binden und zu halten." />
...
<meta property="og:title" content="AI zur Steigerung der Produktivität in Einstellungsteams - Clous Startseite" />
<meta property="og:description" content="Clous hat einen KI-Einstellungsassistenten namens Clous Peer entwickelt. Es wurde entwickelt, um wiederkehrende Kandidaten von der Bewerbung bis zum Interview zu binden und zu halten." />
      </Helmet>
