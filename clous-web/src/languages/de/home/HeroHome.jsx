  ...
  const renderButtons = () => {
    return (
      <div className="flex flex-col justify-center items-center text-xl gap-2 fadeOut">
                ...
                <NormalButton name="Probieren Clous" linkUrl="https://beta.clous.app" target="_blank" onClick={() => trackButtonClick("Demo")}/>
                <div className="flex items-center gap-2 mt-2">
                <p className="text-base text-dark-gray font-medium flex gap-2 items-center">
                Kostenlose Testversion</p> <div className="w-1 h-1 rounded-full bg-dark-gray"></div>
  ...
  const ScrollHeader = ({ translate }) => {
    return (
      ...
      > 
        ...
        Engagiertes Talent von der Bewerbung <br />{' '}
