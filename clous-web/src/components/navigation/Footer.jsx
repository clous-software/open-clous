...
function Footer() {
  ...
  const trackButtonClick2 = (Property) => {
  ...
  const footerNavData = [
    
    {
      title: "Product",
      links: [
        { name: "ClousH", path: "/cloush" },
        { name: "Clous Peer", path: "/clouspeer" },
  ...
  return (
    <footer aria-label="Site Footer" className="bg-[#fafafa] px-2 lg:px-16 2xl:px-24 text-dark-blue-greenish">
     
<section className="flex lg:flex-row flex-col justify-between">
          <div className=" flex-col flex gap-2">
            <Link to="/">
              <img src={logo} className="w-8" alt="Clous IsoLogo" />
            </Link>
            <p className="text-sm font-normal text-shade-gray hidden mt-32 lg:flex">Backed us</p>
          ...
          <div className="sm:flex sm:justify-between">
            ...
            >
              <ul className="flex flex-wrap justify-start gap-4 text-xs lg:justify-end">
                ...
                <a href="/terms-eu" className=" transition hover:opacity-75">
                  EU terms
                </a>
                <a href="/usage" className=" transition hover:opacity-75">
                  Usage policy
                </a>
                <a href="/sharing-policy" className=" transition hover:opacity-75">
                  Sharing policy
                </a>
                <a href="/business-terms" className=" transition hover:opacity-75">
                  Business terms
                </a>
